 ...
 * (explorer / git / terminal / subagent / editor / diff) through the same
 * {@link BetterSidebarService} external plugins use — eating its own
 * dogfood. The terminal descriptor owns its quota (`TERMINAL_LIMIT`) and
 * mints `terminal:<n>` ids through `createTab`.
 */
