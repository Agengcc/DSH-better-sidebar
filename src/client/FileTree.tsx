...
import {
  ...
  IconFolderOpenOutline16, IconLinkOutline16, IconRightUpOutline16, Menu, writeClipboard,
      ...
      */}
      <Menu
        ...
        items={[
          ...
          // File rows additionally offer the upstream open escapes (new tab /
          // to the side, only when the caller provides the callbacks),
          // open-with-default-app, and download (the host routes refuse
          // directories).
          ...(rowMenu?.isDir === false
            ? [
              ...(onOpenFileNewTab !== undefined
                ? [{ id: 'open-new-tab', label: t('openFileNewTab'), icon: <IconCodeOutline16 size={14} /> }]
                : []),
              ...(onOpenFileSide !== undefined
