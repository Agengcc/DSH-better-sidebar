...
export const zh = {
  ...
  settingsTasksTitle: '有新后台任务时自动展开任务管理页',
  settingsTasksDesc: '当前会话出现新的后台任务时，自动展开侧边栏并打开任务管理页（每个新任务都会触发）；关闭后需手动打开',
  ...
  tasks: '后台命令',
  tasksCount: '{count} 个后台命令',
  tasksCountRunning: '{count} 个后台命令 · {running} 运行中',
  taskStatusRunning: '运行中',
  taskStatusStopping: '终止中',
  ...
  taskHideOutput: '收起输出',
  taskNoOutput: '暂无输出',
  taskNotReadYet: '等待模型读取该任务的输出（模型执行 task_output 后，输出会显示在这里）',
  taskOutputTruncated: '输出过长，已截断显示',
  taskOutputError: '输出读取失败',
  taskKill: '终止',
  taskKillConfirm: '再次点击确认终止',
  taskKillError: '终止失败',
}
...
export const en: Record<keyof typeof zh, string> = {
  ...
  settingsTasksTitle: 'Auto-open the Tasks page on a new background task',
  settingsTasksDesc: 'Expand the side card and open the Tasks page whenever a new background task appears for the current conversation (every new task triggers); turn off to open it manually',
  ...
  tasksCount: '{count} background tasks',
  tasksCountRunning: '{count} background tasks · {running} running',
  taskStatusRunning: 'Running',
  taskStatusStopping: 'Stopping',
  taskStatusCompleted: 'Completed',
  taskStatusKilled: 'Killed',
  taskStatusFailed: 'Failed',
  taskDurationSeconds: '{seconds}s',
  taskDurationMinutes: '{minutes}m {seconds}s',
  taskDurationHours: '{hours}h {minutes}m',
  taskViewOutput: 'View output',
  taskHideOutput: 'Hide output',
  taskNoOutput: 'No output yet',
  taskNotReadYet: 'Waiting for the model to read this task; its output appears here once the model runs task_output',
  taskOutputTruncated: 'Output truncated',
  taskOutputError: 'Failed to read output',
  taskKill: 'Kill',
  taskKillConfirm: 'Click again to confirm kill',
