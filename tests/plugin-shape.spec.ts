...
describe('dsh-better-sidebar plugin export shape', () => {
  ...
  it('registers the side card preferences schema with the documented defaults', async () => {
    ...
    expect(overridden).toEqual({ openByDefault: false, defaultWidthPercent: 45, autoOpenSubagent: true, agentTerminalTools: false, interceptOpenPath: true, tabsEnabled: {}, viewersEnabled: {} })
  })
})
